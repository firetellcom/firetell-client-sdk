...
const client = new FiretellClient("your-jwt-token", "your-workspace-domain");
...
const call = new Call(client, {
  ...
  number: "+1234567890", // Phone number to make call (required for external calls)
  isVideo: false,
});
